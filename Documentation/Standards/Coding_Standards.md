...
This document defines the coding standards for the HealthLog application. All code must adhere to these standards. The Review Specialist will enforce compliance during code review.
